...
use super::{
    ...
    platform, shared_adc::SharedAdc, timers, CpuDacOutput1, DigitalInput0,
    DigitalInput1, EemDigitalInput0, EemDigitalInput1, EemDigitalOutput0,
    EemDigitalOutput1, EthernetPhy, GpioDacSpi, HardwareVersion, NetworkStack,
...
///
/// # Returns
/// stabilizer where `stabilizer` is a `StabilizerDevices` structure containing all
